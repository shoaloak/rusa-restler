...
class RestlerSettings(object):
    ...
    def __init__(self, user_args):
        ...
        ## Dynamic parameters
        self._dynamic = SettingsArg('dynamic', bool, False, user_args)
        self._dyn_host = SettingsArg('dyn_host', str, DYN_HOST, user_args)
        self._dyn_port = SettingsArg('dyn_port', int, DYN_PORT, user_args)
        ## proxy parameters
        self._proxy = SettingsArg('proxy', bool, False, user_args)
        self._proxy_host = SettingsArg('proxy_host', str, PROXY_HOST, user_args)
        self._proxy_port = SettingsArg('proxy_port', int, PROXY_PORT, user_args)
    ...
    @property
    def dynamic(self):
        return self._dynamic.val
    
    @property
    def dyn_host(self):
        return self._dyn_host.val
    
    @property
    def dyn_port(self):
        return self._dyn_port.val
    ...
    @property
    def proxy_host(self):
        return self._proxy_host.val

    @property
    def proxy_port(self):
        return self._proxy_port.val
